        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {[
            { title: "Organization Profile", body: aboutCompany },
            {
              ...
              body: "The public URL uses the organization slug for branding and SEO, while all organization, agent, and listing APIs continue to resolve the stable organization hex code internally.",
            },
          ].map((card) => (
