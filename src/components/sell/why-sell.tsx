...
const BuyerVerificationCard = () => (
    <div className="relative w-full max-w-[280px] mx-auto py-8">
        ...
        <div className="bg-card/50 backdrop-blur-md border border-border rounded-2xl p-6 shadow-2xl">
            <div className="h-2.5 bg-blue-600 rounded-t-lg -m-6 mb-6"></div>
            <h3 className="font-bold text-foreground mb-4">Buyer Verification</h3>
...
const WorldMap = () => (
    <div className="relative w-full h-full flex items-center justify-center">
        <Globe className="w-full h-auto max-w-[250px] text-primary/50" strokeWidth={0.5} />
         {/* Pulses */}
                    ...
                    <CarouselItem>
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                            <div className="space-y-4">
                                ...
                                <p className="text-muted-foreground text-sm">We rigorously screen prospective buyers to ensure that you receive the most qualified opportunities.</p>
                            </div>
                            <div className="py-8">
                    ...
                    <CarouselItem>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                            <div className="space-y-4">
                                ...
                                <p className="text-muted-foreground text-sm">Leveraging our network of 1000+ local and international agencies to find the right investor for your asset.</p>
                            </div>
                             <div className="h-56">
                                <WorldMap />
                            </div>
                ...
                {Array.from({ length: count }).map((_, index) => (
                    <button
                        ...
                        className={cn(
                            ...
                            current === index ? 'w-12 bg-primary' : 'w-3 bg-muted'
                        )}
                    />
                ))}
            </div>
