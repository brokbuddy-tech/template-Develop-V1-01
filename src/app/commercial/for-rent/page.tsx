...
export default function CommercialForRentPage() {
  const rentProperties = properties.filter(p => (p.type === 'Office' || p.type === 'Retail' || p.type === 'Industrial') && p.purpose === 'Rent');
  ...
  return (
    <div>
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <ResultsHeader title="Commercial Properties for Rent in Dubai" resultsCount={rentProperties.length}>
