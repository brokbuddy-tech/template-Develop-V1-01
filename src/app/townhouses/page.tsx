...
export default async function TownhousesPage(props: TownhousesPageProps) {
    ...
    <SearchPageLayout initialFilters={initialFilters}>
      <div>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <ResultsHeader title="Townhouses in Dubai">
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 py-12">
          <UniversalPropertyGrid initialPreset={{ category: 'Townhouse' }} />
        </div>
      </div>
    </SearchPageLayout>
  );
