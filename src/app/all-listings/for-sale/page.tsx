...
export default function CommercialForSalePage() {
  const saleProperties = properties.filter(p => (p.type === 'Office' || p.type === 'Retail' || p.type === 'Industrial') && p.purpose === 'Buy');
  ...
  return (
    <div>
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <ResultsHeader title="Commercial Properties for Sale in Dubai" resultsCount={saleProperties.length}>
