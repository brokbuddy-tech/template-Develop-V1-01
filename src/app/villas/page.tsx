...
export default async function VillasPage(props: VillasPageProps) {
  ...
  const { properties: villaProperties } = await getProperties({
    category: 'Villa',
    q,
    minPrice,
    maxPrice,
  ...
  return (
    <div>
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <ResultsHeader title="Villas in Dubai" resultsCount={villaProperties.length}>
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-12">
        <PropertyListings properties={villaProperties} />
        {villaProperties.length > 12 && (
