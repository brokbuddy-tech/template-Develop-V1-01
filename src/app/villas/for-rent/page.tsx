...
export default function VillasForRentPage() {
    ...
    <SearchPageLayout initialFilters={initialFilters}>
      <div>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <ResultsHeader title="Villas for Rent in Dubai">
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 py-12">
          <UniversalPropertyGrid initialPreset={{ category: 'Villa', transactionType: 'RENT' }} />
        </div>
      </div>
    </SearchPageLayout>
  );
